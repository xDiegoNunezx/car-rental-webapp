...
public interface ReservaRepository extends JpaRepository<Reserva, Long> {
    ...
    @Query("SELECT r FROM Reserva r WHERE r.usuario.usuarioId = :usuarioId AND r.cancelada = false")
    List<Reserva> findReservasActivasByUsuarioId(Long usuarioId);
    ...
    @Query("SELECT r FROM Reserva r WHERE r.vehiculo.vehiculo_id = :vehiculoId AND " +
    ...
    @Query("SELECT r FROM Reserva r WHERE r.vehiculo.vehiculo_id = :vehiculoId " +
